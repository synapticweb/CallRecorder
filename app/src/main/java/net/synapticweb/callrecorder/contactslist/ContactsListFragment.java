   ...
   private void deselectContact(int position) {
        ...
        if(parentActivity != null) {
            ...
            fab.setOnClickListener(new View.OnClickListener(){
                ...
                public void onClick(View v) {
                    ...
                    startActivityForResult(pickNumber, REQUEST_ADD_CONTACT);
                }
            });
        }
        return fragmentRoot;
    ...
    private void onAddContactResult(Intent intent) {
        ...
        if(result != null)
            ...
            .show();
        //de văzut dacă trebuie făcut ceva în DOUBLE_PANE
    }

    @Override
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        if(resultCode == Activity.RESULT_OK && requestCode == REQUEST_ADD_CONTACT)
            onAddContactResult(intent);
    }
